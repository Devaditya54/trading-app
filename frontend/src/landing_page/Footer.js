    ...
    <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            <p>Company</p>
            <div className="text-muted d-flex flex-column gap-2 footer-links">
              <a href="">About</a>
              <a href="">Philosophy</a>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <div className="d-flex flex-wrap justify-content-center gap-4 text-muted mt-4 footer-bottom pb-4">
